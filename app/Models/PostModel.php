...
class PostModel {
    ...
    public function lerPosts($condicao = null) {
    ...
    public function armazenar($dados) {
        ...
        $this->db->query("INSERT INTO {$this->tabela} (usuario_id, url, titulo, texto) VALUES (:usuario_id, :url, :titulo, :texto)");

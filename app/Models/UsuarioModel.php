...
class UsuarioModel
{
    ...
    {
        $this->db->query("UPDATE usuarios SET nome = :nome, email = :email, senha = :senha, biografia = :biografia, facebook = :facebook, youtube = :youtube, instagram = :instagram WHERE id = :id");
    ...
    public function atualizarAvatar($dados)
    {
    ...
    public function lerAdmin(){
        $this->db->query("SELECT * FROM usuarios WHERE nivel = 3");
        return $this->db->resultado();
    }
